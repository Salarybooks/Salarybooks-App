        ...
        <View style={styles.container}>
          ...
          <View style={styles.inputCard}>
            ...
            >
              <View style={styles.modalOverlay}>
                <View style={styles.modalBox}>
                  <Image
                    source={require('../assets/logo.png')}
                    style={styles.termLogo}
                    resizeMode="contain"
                  />
                  <View style={styles.termsBox}>
                    <Text style={styles.modalText}>
                      By logging in and using salarybooks, you agree to and accept our Privacy Policy, Refund Policy, and Terms of Use.
                    </Text>
                  </View>
            ...
            <TouchableOpacity
              ...
              disabled={!isAccepted}
            >
              <Text style={[styles.signInText, !isAccepted && styles.disabledButtonText]}>
                Sign In ➜
              </Text>
            </TouchableOpacity>
          </View>
